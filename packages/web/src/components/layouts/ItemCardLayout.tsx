...
import styles from '@/components/layouts/ItemCardLayout.module.scss';
...
const ItemCardLayout: React.FC<ItemCardLayoutProps> = ({ onLayoutScroll, children }) => {
    return (
        <>
            <div
                className={`relative flex justify-center items-start overflow-y-auto max-w-[600px] py-8  bg-white lg:min-w-[200px] min-w-full mt-0 mx-auto my-0 z-50 ${styles.itemCardLayout}`}
